...
class Lap_stok_masuk_m extends CI_Model
{
    public $table        = 'v_masuk';
    public $column_order = array(null, 'masuk_nomor', 'masuk_tanggal', 'masuk_keterangan', 'user_name', 'penerima',
...
/* Location: ./application/model/admin/Lap_stok_masuk_m.php */
