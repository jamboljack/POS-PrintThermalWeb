...
class Lap_stok_keluar_m extends CI_Model
{
    public $table         = 'v_keluar';
    public $column_order  = array(null, 'keluar_nomor', 'keluar_tanggal', 'keluar_keterangan', 'user_name');
    public $column_search = array('keluar_nomor', 'keluar_tanggal', 'keluar_keterangan', 'user_name');
    public $order         = array('keluar_tanggal' => 'desc');
...
/* Location: ./application/model/admin/Lap_stok_keluar_m.php */
