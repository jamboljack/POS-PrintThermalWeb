...
class Lap_jual_pelanggan_m extends CI_Model
{
    public $table        = 'v_penjualan_detail';
    public $column_order = array(null, 'penjualan_tanggal', 'pelanggan_nama', 'penjualan_detail_kode',
        'penjualan_detail_nama', 'penjualan_detail_qty', 'penjualan_detail_harga',
        'penjualan_detail_disc', 'penjualan_detail_subtotal');
    public $column_search = array('penjualan_tanggal', 'pelanggan_nama', 'penjualan_detail_kode', 'penjualan_detail_nama',
...
/* Location: ./application/model/admin/Lap_jual_pelanggan_m.php */
