...
<div class="page-content-wrapper">
    <div class="page-content">
        <h3 class="page-title">Laporan Rekap Penjualan</h3>
        <div class="page-bar">
...
$(document).ready(function() {
    table = $('#tableData').DataTable({
        ...
        "pageLength": 20,
        "ajax": {
            "url": "<?=site_url('admin/lap_jual_rekap/data_list')?>",
            "type": "POST",
            "data": function(data) {
...
function printPeriode() {
    ...
    var url = "<?=site_url('admin/lap_jual_rekap/printrekap/');?>"+dari+"/"+sampai+"/"+pelanggan;
