...
<div class="page-content-wrapper">
    <div class="page-content">
        <h3 class="page-title">Laporan Penjualan per Periode</h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">Penjualan per Periode</a>
                </li>
            </ul>
                ...
                <div class="portlet box blue-madison">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            ...
                            <a onclick="printPeriode()" class="btn btn-danger btn-xs">
...
$(document).ready(function() {
    table = $('#tableData').DataTable({
        ...
        "pageLength": 20,
        "ajax": {
            "url": "<?=site_url('admin/lap_jual_periode/data_list')?>",
            "type": "POST",
            "data": function(data) {
...
function printPeriode() {
    ...
    var url = "<?=site_url('admin/lap_jual_periode/printperiode/');?>"+dari+"/"+sampai+"/"+pelanggan;
