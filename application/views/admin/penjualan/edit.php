    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">No. Transaksi : <?=$detail->penjualan_no;?></a>
                </li>
            </ul>
                                ...
                                <form role="form" class="form-horizontal form" method="post" id="formInput" name="formInput">
                                    <div class="form-body">
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="tanggal" id="tanggal" value="<?=date('d-m-Y', strtotime($detail->penjualan_tanggal));?>" readonly>
                                            </div>
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="hari" id="hari" value="<?=getDay(date('d-m-Y', strtotime($detail->penjualan_tanggal)));?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                ...
                                <form role="form" class="form-horizontal form" method="post" id="formTotal" name="formTotal">
                                    <div class="form-body">
                                        <div class="row static-info align-reverse">
                                            <div class="col-md-12 value">Rp. <?=number_format($detail->penjualan_total,0,'',',');?></div>
                                        </div>
                                    </div>
                                    <br><br>
                                </form>
        ...
        <div class="row">
            <div class="col-md-8">
                <a class="btn btn-sm blue hidden-print" href="<?=site_url('admin/penjualan/printfaktur/'.$detail->penjualan_id);?>" target="_blank"><i class="fa fa-print"></i> Print Faktur</a>
            </div>
            <div class="col-md-4">
                <div class="well">
                    <div class="row static-info align-reverse">
                        <div class="col-md-7 name"><b>Sub Total :</b></div>
                        <div class="col-md-4 name"><?=number_format($detail->penjualan_subtotal,0,'',',');?></div>
                    </div>
                    <div class="row static-info align-reverse">
                        <div class="col-md-7 name"><b>Diskon :</b></div>
                        <div class="col-md-4 name"><?=number_format($detail->penjualan_diskon,0,'',',');?></div>
                    </div>
                    <div class="row static-info align-reverse">
                        <div class="col-md-7 name"><b>Diskon POIN :</b></div>
                        <div class="col-md-4 name"><?=number_format($detail->penjualan_tukar_poin_rp,0,'',',');?></div>
                    </div>
                    <div class="row static-info align-reverse">
                        <div class="col-md-7 name"><b>TOTAL :</b></div>
                        <div class="col-md-4 name"><?=number_format($detail->penjualan_total,0,'',',');?></div>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    table = $('#tableData').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?=site_url('admin/penjualan/data_order_list/')?>"+penjualan_id,
            "type": "POST"
        },
        "columnDefs": [
            {
