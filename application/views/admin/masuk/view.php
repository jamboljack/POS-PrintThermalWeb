                ...
                <div class="portlet box blue-madison">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            ...
                            <a href="<?=site_url('admin/masuk/adddata');?>">
...
$(document).ready(function() {
    table = $('#tableData').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?=site_url('admin/masuk/data_list')?>",
            "type": "POST",
            "data": function(data) {
...
function hapusData(masuk_id) {
    ...
    swal({
        ...
        if (!isConfirm) return;
        $.ajax({
            url : "<?=site_url('admin/masuk/deletedata')?>/"+id,
            type: "POST",
...
function printBukti(masuk_id) {
    var url = "<?=site_url('admin/masuk/printbukti/');?>"+masuk_id;
