...
<div class="page-content-wrapper">
    <div class="page-content">
        <h3 class="page-title">Tipe Bayar</h3>
        <div class="page-bar">
            ...
            <div class="col-md-12">
                <div class="portlet box blue-madison">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-list"></i> Daftar Tipe Bayar
                        </div>
                        <div class="actions">
...
$(document).ready(function() {
    table = $('#tableData').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?=site_url('admin/tipe/data_list');?>",
            "type": "POST"
        },
        "columnDefs": [
            {
...
$(document).ready(function() {
    ...
    $("#formInput").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: '<?=site_url('admin/tipe/savedata');?>',
                type: "POST",
                data: dataString,
...
function edit_data(id) {
    $('#formEdit')[0].reset();
    $.ajax({
        url : "<?=site_url('admin/tipe/get_data/');?>"+id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            $('#id').val(data.tipe_id);
            $('#tipe_nama').val(data.tipe_nama);
...
$(document).ready(function() {
    ...
    $("#formEdit").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: '<?=site_url('admin/tipe/updatedata');?>',
                type: "POST",
                data: dataString,
                success: function(data) {
                    swal({
...
function hapusData(tipe_id) {
    ...
    swal({
        ...
        if (!isConfirm) return;
        $.ajax({
            url : "<?=site_url('admin/tipe/deletedata')?>/"+id,
            type: "POST",
            success: function(data) {
                swal({
                    title:"Sukses",
        ...
        <div class="modal-content">
            <form role="form" action="" method="post" id="formInput" class="form-horizontal">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-plus-circle"></i> Form Tambah Tipe</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-md-4 control-label">Nama Tipe</label>
                        <div class="col-md-8">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" action="" method="post" id="formEdit" class="form-horizontal">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title"><i class="fa fa-edit"></i> Form Edit Tipe</h4>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-md-4 control-label">Nama Tipe</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" placeholder="Input Nama Tipe" name="name" id="tipe_nama" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
