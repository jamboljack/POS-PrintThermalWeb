...
<title>Print Bukti : <?=$detail->keluar_nomor;?></title>
<style type="text/css">
    table {
        width: 100%;
...
<div class="page">
    <table width="100%" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td width="50%" colspan="4" align="right" valign="top"><h1><u>BUKTI STOK KELUAR</u></h1></td>
        </tr>
        <tr>
            ...
            <td width="33%" valign="top"><?=date('d-m-Y', strtotime($detail->keluar_tanggal));?></td>
        </tr>
        <tr>
            <td valign="top">No. Transaksi</td>
            <td valign="top">:</td>
            <td valign="top"><?=trim($detail->keluar_nomor);?></td>
        </tr>
        <tr>
            <td valign="top">Keterangan</td>
            <td valign="top">:</td>
            <td valign="top"><?=trim($detail->keluar_keterangan);?></td>
        </tr>
    </table>
    <br>
    <table width="100%" align="center">
        ...
        <tr>
            ...
            <td align="right" style="border-right: 0.5px solid black; border-bottom: 0.5px solid black;"><?=number_format($r->keluar_detail_qty, 0, '', ',');?></td>
        </tr>
        <?php
			$total = $total + $r->keluar_detail_qty;
	    	$no++;
		}
		?>
        <tr>
    ...
    <table width="100%" align="center">
        <tr>
            <td width="100%" align="center">Petugas<br><br><br><br></td>
        </tr>
        <tr>
            <td align="center"><?=$detail->user_name;?></td>
        </tr>
    </table>
</div>
</body>
