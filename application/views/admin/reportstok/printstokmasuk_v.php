...
<div class="page">
    <table width="100%" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td align="center" valign="top" style="font-size: 15px; font-weight: bold;"><u>STOK MASUK</u></td>
        </tr>
        <tr>
    ...
    <table width="100%">
        ...
        ?>
        <tr>
            <th align="left" colspan="3" style="border-top: 0.5px solid black; border-left: 0.5px solid black;">Tanggal : <?=date('d-m-Y', strtotime($r->masuk_tanggal));?> | No. Transaksi : <?=$r->masuk_nomor;?></th>
            <th align="left" colspan="2" style="border-top: 0.5px solid black; border-right: 0.5px solid black;">Penerima : <?=$r->penerima;?></th>
        </tr>
        <?php 
            $listDetail = $this->db->get_where('v_masuk_detail', array('masuk_id' => $masuk_id))->result();
            $no = 1;
        ...
        <tr>
            ...
            <td align="center" style="border-top: 0.5px solid black; border-bottom: 0.5px solid black; border-right: 0.5px solid black;"><?=number_format($d->masuk_detail_qty,0,'',',');?></td>
        </tr>
        <?php
            $no++; 
            }
        ?>
        <tr>
            <td colspan="7" style="border: 0.5px solid black;">KETERANGAN : <?=$r->masuk_keterangan;?></td>
        </tr>
        <tr>
            <td colspan="7" style="border: 0.5px solid black;">STATUS : <?=($r->masuk_status == 'B' ? 'BARU' : 'TERIMA');?></td>
        </tr>
        <tr>
            <td colspan="7"><br></td>
        </tr>
