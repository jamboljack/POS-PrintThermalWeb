...
<title>Print Faktur : <?=$detail->retur_jual_no;?></title>
<style type="text/css">
    table {
        width: 100%;
...
<div class="page">
    <table width="100%" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td width="50%" colspan="4" align="right" valign="top"><h1><u>BUKTI RETUR PENJUALAN</u></h1></td>
        </tr>
        <tr>
            ...
            <td width="33%" valign="top"><?=date('d-m-Y', strtotime($detail->retur_jual_tanggal));?></td>
        </tr>
        <tr>
            <td valign="top">No. Transaksi</td>
            <td valign="top">:</td>
            <td valign="top"><?=trim($detail->retur_jual_no);?></td>
        </tr>
        <tr>
    ...
    <table width="100%" align="center">
        ...
        <tr>
            ...
            <td align="center" style="border-bottom: 0.5px solid black; border-right: 0.5px solid black;"><?=$r->retur_jual_detail_kode;?></td>
            <td style="border-bottom: 0.5px solid black; border-right: 0.5px solid black;"><?=$r->retur_jual_detail_nama;?></td>
            <td align="center" style="border-right: 0.5px solid black; border-bottom: 0.5px solid black;"><?=number_format($r->retur_jual_detail_qty, 0, '', ',');?></td>
            <td align="right" style="border-bottom: 0.5px solid black; border-right: 0.5px solid black;"><?=number_format($r->retur_jual_detail_harga,0,'',',');?></td>
            <td align="right" style="border-right: 0.5px solid black; border-bottom: 0.5px solid black;"><?=number_format($r->retur_jual_detail_disc, 2, '.', ',');?></td>
            <td align="right" style="border-right: 0.5px solid black; border-bottom: 0.5px solid black;"><?=number_format($r->retur_jual_detail_subtotal, 0, '', ',');?></td>
        </tr>
        <?php
	    	$no++;
		}
        ...
        <tr>
            ...
            <td align="right"><b><?=number_format($detail->retur_jual_total, 0, '', ',');?></b></td>
        </tr>
    </table>
</div>
</body>
